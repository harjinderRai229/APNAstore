...
const SignUp = () => {
    return (
        <ScrollView style={styles.container}>
            ...
            <CustomTextInput placeholder={"Enter Your Name"} icon={require('../assets/images/email.png')} />
            <CustomTextInput placeholder={"Enter Your Email"} icon={require('../assets/images/email.png')} />
            <CustomTextInput placeholder={"Enter your Password"} type={"password"} icon={require('../assets/images/lock.png')} />
