...
const SignUp = () => {
    return (
        <ScrollView style={styles.container}>
            ...
            <CustomTextInput placeholder={"Enter Your Name"} icon={require('../assets/images/email.png')} />            <CustomTextInput placeholder={"Enter Your Name"} icon={require('../assets/images/email.png')} />
